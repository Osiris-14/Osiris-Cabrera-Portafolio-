...
export default function Home() {
  const featuredProjects = projects.filter(p => p.visible !== false).slice(0, 3);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                I've developed experience working with data across its full lifecycle — from analysis and exploration to building solutions that turn raw information into actionable value.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Throughout this journey, I've applied Data Analytics, Data Engineering, and AI & Machine Learning to develop analysis workflows, data models, and pipelines oriented toward solving real-world problems and supporting decision-making.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Tools and technologies I use to design, build, and maintain robust data pipelines and infrastructure.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <motion.div className="max-w-2xl" {...fadeInUp}>
              ...
              <p className="text-lg text-muted-foreground">
                A selection of end-to-end data engineering solutions — from ingestion and transformation to analytics-ready data layers.
              </p>
            </motion.div>
            <motion.div {...fadeInUp}>
              <Link
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeInUp}>
                <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground mb-8">
                  Ready to build something with data?
                </h2>
                <p className="text-xl text-primary-foreground/80 mb-10">
                  Open to full-time Data Engineer roles, freelance projects, and collaborations. If you have a data challenge, let's talk.
                </p>
